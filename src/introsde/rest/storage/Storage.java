...
public class Storage {
     ...
     public Response getQuote() throws ClientProtocolException, IOException {
     	...
     	//String ENDPOINT = "http://10.218.200.46:5700/introsde/adapter/getQuote";
     	String ENDPOINT = "https://eadapter.herokuapp.com/introsde/adapter/getQuote";
   ...
   //Getting a motivation quote from forismatic
     ...
     public Response getQuote2() throws ClientProtocolException, IOException {
     	...
     	//String ENDPOINT = "http://10.218.200.46:5700/introsde/adapter/getQuote2";
     	String ENDPOINT = "https://eadapter.herokuapp.com/introsde/adapter/getQuote2";
     	DefaultHttpClient client = new DefaultHttpClient();
     	HttpGet request = new HttpGet(ENDPOINT);
     	HttpResponse response = client.execute(request);
    ...
    @Consumes({MediaType.APPLICATION_JSON}) //The @Consumes annotation is used to specify which MIME media types of representations a resource can accept, or consume, from the client.
